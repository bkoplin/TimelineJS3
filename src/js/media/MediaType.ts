...
import GoogleMap from './types/GoogleMap.js'
import Blockquote from './types/Blockquote.js'
import Wikipedia from './types/Wikipedia.js'
import SoundCloud from './types/SoundCloud.js'
import Vimeo from './types/Vimeo.js'
import DailyMotion from './types/DailyMotion.js'
import Vine from './types/Vine.js'
import Twitter from './types/Twitter.js'
import TwitterEmbed from './types/TwitterEmbed.js'
import Flickr from './types/Flickr.js'
import DocumentCloud from './types/DocumentCloud.js'
import Instagram from './types/Instagram.js'
import Profile from './types/Profile.js'
import GoogleDoc from './types/GoogleDoc.js'
import Spotify from './types/Spotify.js'
import IFrame from './types/IFrame.js'
import Imgur from './types/Imgur.js'
import PDF from './types/PDF.js'
import Audio from './types/Audio.js'
import Video from './types/Video.js'
import Wistia from './types/Wistia.js'
...
export function lookupMediaType(
  m, image_only,
) {
  let media = {}
  const media_types = [{
